...
<style>
	.controls { display: grid; grid-template-columns: minmax(0, 1.5fr) minmax(0, 0.75fr) minmax(0, 0.75fr); gap: 0.55rem; padding-top: 0.65rem; border-top: 1px solid #2c3334; }
	label { min-width: 0; }
