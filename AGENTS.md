...
* Favor multiple simple, focused pages and routes over a small number of dense pages with lots of unrelated state and interactivity. Each page should have one clear job and be easy to use on a phone.
